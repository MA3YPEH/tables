...
$PAGE->requires->js(new moodle_url($CFG->wwwroot . '/mod/tables/amd/src/grade_students.js?v=1.1'));
...
switch($selector) {
                    ...
                    if ($sheet->tableid == $moduleinstance->id) {
                        ...
                        echo '
                                        <tr>
                                            ...
                                            <td>
                                                <input class="m-tables-grades-active-input" id="grade_input_' . $grade->id . '" data-correctid="' . $grade->id . '" type="number" oninput="onchangeGrade(this)" data-old-value="' . $grade->grade . '" value="' . $grade->grade . '" ';
    ...
    case 'students':
    {
        $students = get_enrolled_users($modulecontext, '', 0, 'u.id, u.firstname, u.lastname');

        echo '<table class="m-tables-students-table" id="students_table">
                                <thead>
                                    <tr>
                                        <th>
    ' . get_string("fullname") . '
        ...
        foreach ($students as $student) {
            ...
            foreach ($grades as $grade) {
                ...
                if ($sheet->tableid == $moduleinstance->id) {
                    ...
                    echo '>
                                                <span class="m-tables-blue-btn" id="submit_button_' . $grade->id . '" data-studentid="' . $student->id . '" data-updatetype="update_grade" data-correctid="' . $grade->id . '" onclick="onclickSubmitGrade(this)" style="display: none">
                                                    <i class="fa fa-floppy-o" ></i>
                                                </span>
                                            </td>
                                        </tr>

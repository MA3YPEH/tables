...
/**
 * The main mod_tables configuration form.
 *
 * @package     mod_tables
 ...
 * @license     https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_tables_mod_form extends moodleform_mod {
    ...
    public function definition() {
        ...
        $mform->addElement('text', 'name', get_string('tablesname', 'mod_tables'), array('size' => '64'));
        ...
        $mform->addHelpButton('name', 'tablesname', 'mod_tables');
    ...
    protected function get_default_rowcount() {
        if(!empty($CFG->tables_rowcount))
        {
    ...
    protected function get_default_columncount() {
        if(!empty($CFG->tables_columncount))
        {

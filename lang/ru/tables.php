...
$string['fraction'] = 'Набранный балл';
$string['groupgrade'] = 'Оценки группы';
$string['maxfraction'] = 'Наивысшый балл';
$string['modulename'] = 'Таблица';
$string['modulenamepre'] = 'Таблицу';
$string['modulenameplural'] = 'Таблицы';
$string['no_groups'] = 'Нет групп';
$string['noattempts'] = 'Еще не делал попыток';
...
$string['sheet'] = "Лист";
$string['sumresult'] = 'Суммарный результат';
$string['studentgrade'] = 'Суммарная оценка';

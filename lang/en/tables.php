...
$string['groupgrade'] = 'Group grades';
$string['maxfraction'] = 'Max fraction';
$string['modulename'] = 'Table';
$string['modulenameplural'] = 'Tables';
$string['modulenamepre'] = 'Table';
$string['no_groups'] = 'No groups';
$string['noattempts'] = 'Has no attempts';
...
$string['send'] = 'Send';
$string['sheet'] = "Sheet";
$string['sumresult'] = 'Summary result';
$string['studentgrade'] = 'Total score';
